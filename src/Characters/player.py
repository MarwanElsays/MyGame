...
class Player:
    def __init__(self, speedx, tile_map):
        ...
        self.__animations = {
            "idle": Animation(load_images("Player/idle", self.__scale), 10, "idle"),
            ...
            "wall_slide": Animation(
                load_images("Player/wall_slide", self.__scale), 10, "wall_slide"
            ),
        }
    ...
    def render(self, screen, offset):
        screen.blit(
            pygame.transform.flip(self.__image, self.__flip, False),
            (
                self.__rect.x - offset[0] + self.__slide_offset,
